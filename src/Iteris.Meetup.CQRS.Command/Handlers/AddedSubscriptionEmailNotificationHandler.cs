...
{
    public class AddedSubscriptionEmailNotificationHandler : INotificationHandler<AddedSubscriptionNotification>
    {
        private readonly ILogger<AddedSubscriptionPushNotificationHandler> _logger;

        public AddedSubscriptionEmailNotificationHandler(ILogger<AddedSubscriptionPushNotificationHandler> logger)
        {
            _logger = logger;
        }
